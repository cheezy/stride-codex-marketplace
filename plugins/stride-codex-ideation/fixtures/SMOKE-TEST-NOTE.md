...
The interactive `stride-ideation-ideate` flow has to be re-run by a human in Codex CLI (or any platform with the plugin installed) — the README walks through the procedure.
