...
|---|---|---|---|
| `decomposition_notes` | yes | string | Explains seam choices and any cross-goal claim ordering. Stripped by the stride-ideation-stridify skill before POST (kept on disk in the audit JSON). |
