...
# skills/stride-ideation/SKILL.md (W1370) and wired into
# skills/stride-ideation-ideate/SKILL.md (W1370). The gate is an interactive
# Codex CLI question step that cannot be driven from a non-interactive runner,
# so this test asserts the *output contract* — the shape a committed
...
# section of skills/stride-ideation/SKILL.md and the Step-6 "## Design
# challenge" template in skills/stride-ideation-ideate/SKILL.md. If you change
# the documented gate output, update this test and the fixture together — this
# test exists to catch drift between the documented contract and a real example
# of its output.
#
# Run:
