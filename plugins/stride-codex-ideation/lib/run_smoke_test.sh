...
#
# Composes every helper the stridify skill body invokes — in the
...
# trade-off, plus confidence-rated Assumptions. Offline and deterministic — no
# network, no Stride API.
