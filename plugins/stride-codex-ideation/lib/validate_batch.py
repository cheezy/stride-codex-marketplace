#!/usr/bin/env python3
"""Validate a Stride batch JSON document produced by the stride-ideation-stridify skill.

Usage:
    python3 lib/validate_batch.py <path-to-stride-batch.json>

Exits 0 on success; advisory warnings (see below) print to stderr and never
...
warns (stderr, prefix "stride-ideation: warning:") for any task whose
