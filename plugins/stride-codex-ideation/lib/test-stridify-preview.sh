...
# skills/stride-ideation-stridify/SKILL.md (W1161; ports upstream G235/W1140). Codex CLI's question UI is
# only available inside a live Codex CLI session, so this test embeds a
...
#
# Mirrors skills/stride-ideation-stridify/SKILL.md Step 1. --yes and --auto-approve are bare boolean tokens
...
#
# Mirrors skills/stride-ideation-stridify/SKILL.md Step 8.5 a/b/c. Args:
