<#
.SYNOPSIS
    Frontmatter smoke test for the stride-codex-exploratory-testing plugin (PowerShell twin).
...
Write-Host "stride-codex-exploratory-testing frontmatter smoke test"
